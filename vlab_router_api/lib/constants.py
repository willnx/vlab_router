...
DEFINED = OrderedDict([
            ('VLAB_ROUTER_LOG_LEVEL', environ.get('VLAB_ROUTER_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'router-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_ROUTER_IMAGES_DIR', environ.get('VLAB_ROUTER_IMAGES_DIR', '/images')),
          ])
